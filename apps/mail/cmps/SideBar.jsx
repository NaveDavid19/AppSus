...
export function SideBar({ setOpenCompose, openCompose, setSelectedTab, unreadCount, onSendMail }) {
    return <nav className="side-bar">
        <div className="side-bar-list">
            ...
            <Link title="Trash" className="side-bar-btn trash" to={`/mail/${Tabs.TRASH}`} onClick={() => setSelectedTab(Tabs.TRASH)}><i className="fa-solid fa-trash"></i><span className="side-btn"> Trash</span></Link>
        </div>
    </nav>;
}
